...
gamaList1 = [9, 9, 9, 9, 9, 9, 9, 9]
gamaList2 = [9, 9, 9, 9, 9, 9, 9, 9, 9]
gamaList3 = [9, 9, 9, 9, 9, 9, 9]
gamaL = [gamaList1, gamaList2, gamaList3]
...
for fileIndex in range(numFile):
    ...
    name = strTemp + 'new2/d37e6_acc_' + str(fileIndex + 3) + '.csv'
